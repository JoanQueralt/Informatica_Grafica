...
int main() {
	...
	while (!glfwWindowShouldClose(window)) {
		...
		//1
		glVertex3f(-1.0f, 3.f, 0.f);
		//2
		glVertex3f(-1.55f, 2.65f, 0.f);
		//3
		glVertex3f(-2.0f, 2.f, 0.f);
		//4
		glVertex3f(-2.18f, 1.2f, 0.f);
		//5
		glVertex3f(-2.2f, 0.5f, 0.f);
		//6
		glVertex3f(-2.18f, -0.2f, 0.f);
		//7
		glVertex3f(-2.0f, -1.f, 0.f);
		//8
		glVertex3f(-1.7f, -1.5f, 0.f);
		//9
		glVertex3f(-1.0f, -2.f, 0.f);
		//10
		glVertex3f(0.f, -2.2f, 0.f);
		//11
		glVertex3f(1.0f, -2.f, 0.f);
		//12
		glVertex3f(1.6f, -1.5f, 0.f);
		//13
		glVertex3f(2.0f, -1.f, 0.f);
		//14
		glVertex3f(2.15f, -0.2f, 0.f);
		//15
		glVertex3f(2.2f, 0.5f, 0.f);
		//16
		glVertex3f(2.15f, 1.2f, 0.f);
		//17
		glVertex3f(2.0f, 2.f, 0.f);
		//18
		glVertex3f(1.6f, 2.5f, 0.f);
		//19
		glVertex3f(1.0f, 3.f, 0.f);
		//20
		glVertex3f(0.f, 3.2f, 0.f);
		...
		glVertex3f(-1.f, 0.8f, 0.f);
		glVertex3f(-0.5f, 0.8f, 0.f);
		glVertex3f(-0.5f, 2.f, 0.f);
		glEnd();
		...
		glVertex3f(-0.3f, -1.2f, 0.f);
		glVertex3f(-0.1f, -1.3f, 0.f);
		glVertex3f(0.1f, -1.3f, 0.f);
		glVertex3f(0.3f, -1.2f, 0.f);
		glVertex3f(0.7f, -1.0f, 0.f);
		glVertex3f(1.f, -0.5f, 0.f);
		//glVertex3f(0.9f, 0.f, 0.f);
		glEnd();
